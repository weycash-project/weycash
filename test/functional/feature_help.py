...
"""Verify that starting monacoin with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start monacoin with -h for help text")
        ...
        self.log.info("Start monacoin with -version for version information")
        ...
        self.log.info("Start weycashd with -fakearg to make sure it does not start")
