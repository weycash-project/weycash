...
* weycash.conf: contains configuration settings for weycashd or monacoin-qt
* weycashd.pid: stores the process id of weycashd while running
...
* debug.log: contains debug information and general logging generated by weycashd or monacoin-qt
